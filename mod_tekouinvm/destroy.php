...
$PAGE->set_url('/mod/tekouinvm/destroy.php', array('id' => $id, 'userid' => $userid, 'courseid' => $courseid));
$context = context_course::instance($courseid);
$can_manage = has_capability('mod/tekouinlab:view', $context);

$PAGE->set_title(get_string('destroy_vm', 'mod_tekouinvm'));
$PAGE->set_heading(get_string('destroy_vm', 'mod_tekouinvm'));
...
if ($response['status'] === 'success') {
    redirect(new moodle_url('/mod/tekouinvm/view.php', array('id' => $id)), $response['message'], null, \core\output\notification::NOTIFY_SUCCESS);
} else {
    echo $OUTPUT->header();
