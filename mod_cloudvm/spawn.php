...
$PAGE->set_url('/mod/cloudvm/spawn.php', array('id' => $cm->id));
$PAGE->set_context($context);

$PAGE->set_title(get_string('spawn_vm', 'mod_cloudvm'));
$PAGE->set_heading(get_string('spawn_vm', 'mod_cloudvm'));
...
if ($result['status'] == 'success') {
    redirect(new moodle_url('/mod/cloudvm/view.php', array('id' => $id)), $result['message'], null, \core\output\notification::NOTIFY_SUCCESS);
