...
$PAGE->set_url(new moodle_url('/local/tekouin/admin/index.php'));
$PAGE->set_title(get_string('pluginname', 'local_tekouin'));
$PAGE->set_heading(get_string('pluginname', 'local_tekouin'));
...
echo '<div id="tekouin-admin">';
echo '  <h2>' . get_string('checkapistatus', 'local_tekouin') . '</h2>';
echo '  <p id="api-status">Loading API status...</p>';
echo '  <h2>' . get_string('availablevms', 'local_tekouin') . '</h2>';
echo '  <ul id="vm-list"></ul>';
echo '  <h2>' . get_string('availablelabs', 'local_tekouin') . '</h2>';
