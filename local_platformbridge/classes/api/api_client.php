...
class local_platformbridge_api_client {
    private $apiurl;
    private $apikey;
    private $orgid;

    public function __construct() {
        $this->apiurl = get_config('local_platformbridge', 'apiurl');
        $this->apikey = get_config('local_platformbridge', 'apikey');
        $this->orgid = get_config('local_platformbridge', 'orgid');
    }
